...
<div class="o-container u-margin-top-30@medium  u-margin-bottom-40">
    <div class="o-row">
        ...
        <div class="o-row__column o-row__column--span-12 o-row__column--span-12@small o-row__column--span-12@mobile o-row__column--span-4@medium c-term-page-sidebar">  
        <?php if ( is_active_sidebar('primary-sidebar') ) { ?>
            <?php get_sidebar(); ?>
                    <?php } ?>
        </div>
