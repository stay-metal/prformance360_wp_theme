...
var posts_tag = '<?php echo serialize( $custom_query->query_vars ) ?>';
var   current_page_tag = <?php echo $custom_query->query_vars['paged'] ?>;
var  max_page_tag = <?php echo $custom_query->max_num_pages ?>;
</script>
    </div>
    <?php // LAZY LOAD
